    ...
    <div class="row">
      <div class="col-md-6">
        <ul class="site-menu d-flex align-items-center justify-content-start">
          ...
          <li class="nav-item"><a class="nav-link text-dark" href="https://www.instagram.com/arthurcitramedia/"><img src="images/instagram.png"></a></li>
          <li class="nav-item"><a class="nav-link text-dark" href="https://shopee.co.id/arthuradv?smtt=0.0.9"><img src="images/shopee.png"></a></li>
          <li class="nav-item"><a class="nav-link text-dark" href="https://www.tokopedia.com/archive-arthuradv"><img src="images/tokped.png"></a></li>
        </ul>
      </div>
      <div class="col-md-6">
